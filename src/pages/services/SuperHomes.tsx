    ...
    <div className="pt-[70px]">
      ...
      <div className="flex flex-col md:flex-row" style={{ minHeight: '400px' }}>
        <div className="w-full md:w-1/2 overflow-hidden">
          <img src={IMG1} alt="Super Home steel frame" className="w-full h-full object-cover" style={{ minHeight: '400px' }} />
        </div>
        <div className="w-full md:w-1/2 bg-white flex items-center px-10 lg:px-16 py-14">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Commercial Strength</h2>
      ...
      <div className="flex flex-col md:flex-row" style={{ minHeight: '400px' }}>
        <div className="w-full md:w-1/2 bg-white flex items-center px-10 lg:px-16 py-14 md:order-1">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Residential Beauty</h2>
            <p className="text-gray-600 leading-relaxed">
        ...
        <div className="w-full md:w-1/2 overflow-hidden md:order-2">
          <img src={IMG2} alt="Finished Super Home" className="w-full h-full object-cover" style={{ minHeight: '400px' }} />
        </div>
      </div>
