    ...
    script.text = JSON.stringify({
      ...
      "hasOfferCatalog": {
        ...
        "itemListElement": [{
          ...
          "itemOffered": {
            "@type": "Service",
            "name": "Retention Pond Excavation",
            "provider": {
              "@type": "LocalBusiness",
              "name": "Upward Development"
            }
      ...
      <section className="relative py-24 bg-black text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Retention Pond Digging</h1>
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Upward Development digs and shapes custom retention and detention ponds to satisfy parish storm water requirements or to create a beautiful water feature on your property.
              </p>
