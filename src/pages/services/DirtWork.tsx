    ...
    <div className="pt-[70px]">
      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-1/2">
          <img src={IMG1} alt="Dirt work" className="w-full h-full object-cover" style={{ minHeight: '300px', maxHeight: '420px' }} />
        </div>
        <div className="w-full md:w-1/2">
          <img src={IMG2} alt="Excavation" className="w-full h-full object-cover" style={{ minHeight: '300px', maxHeight: '420px' }} />
        </div>
      </div>
