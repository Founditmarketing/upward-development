            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li className="pt-2">
                <div className="flex items-center gap-4">
                  {/* Instagram */}
                  <a href="https://www.instagram.com/upwarddevelopmentllc/" target="_blank" rel="noopener noreferrer" aria-label="Upward Development on Instagram" className="text-gray-400 hover:text-primary transition-colors">
                  ...
                  {/* Facebook */}
                  <a href="https://www.facebook.com/UpwardDevelopmentLLC" target="_blank" rel="noopener noreferrer" aria-label="Upward Development on Facebook" className="text-gray-400 hover:text-primary transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                  </a>
                  {/* TikTok */}
                  <a href="https://www.tiktok.com/@upward.developmen" target="_blank" rel="noopener noreferrer" aria-label="Upward Development on TikTok" className="text-gray-400 hover:text-primary transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.75a8.18 8.18 0 004.77 1.52V6.84a4.84 4.84 0 01-1-.15z"/></svg>
                  </a>
                  {/* YouTube */}
                  <a href="https://www.youtube.com/@UpwardDevelopmentLLC" target="_blank" rel="noopener noreferrer" aria-label="Upward Development on YouTube" className="text-gray-400 hover:text-primary transition-colors">
