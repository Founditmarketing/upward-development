        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            >
              ...
              {isServicesOpen && (
                <div className="absolute top-full left-1/2 -translate-x-1/2 w-56 bg-white border border-gray-100 shadow-xl rounded-sm py-4 px-2 z-50">
                  <Link to="/services/dirt-work" className="block px-4 py-2 text-sm font-semibold hover:bg-gray-50 hover:text-primary rounded-sm transition-colors" onClick={() => setIsServicesOpen(false)}>Dirt Work</Link>
                  <Link to="/services/land-clearing" className="block px-4 py-2 text-sm font-semibold hover:bg-gray-50 hover:text-primary rounded-sm transition-colors" onClick={() => setIsServicesOpen(false)}>Land Clearing</Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-4 shadow-lg h-[calc(100vh-80px)] overflow-y-auto">
          ...
          <div className="space-y-2">
              <div className="font-semibold text-gray-900 border-b border-gray-100 pb-2 mb-2">Services</div>
